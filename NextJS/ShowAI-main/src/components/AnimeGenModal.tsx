...
import { animeModels, AnimeModel } from '../utils/animeModels';
import AnimeModelSelector from './AnimeModelSelector';

interface AnimeGenModalProps {
    isOpen: boolean;
    onClose: () => void;
}
...
const AnimeGenModal: React.FC<AnimeGenModalProps> = ({ isOpen, onClose }) => {
    ...
    const [selectedModel, setSelectedModel] = useState<AnimeModel>(animeModels[0]);
    ...
    const handleModelChange = (newModel: AnimeModel) => {
    ...
    // Các hàm xử lý khác giống như AIImageGenModal
                                ...
                                <div className="flex-grow overflow-y-auto p-4 space-y-4">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <textarea
                                            ...
                                            placeholder="Nhập mô tả hình ảnh anime bạn muốn tạo..."
                                            className="w-full p-3 rounded-xl bg-[#1E293B] text-white border border-white/10 
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
                                            {generatedImages.map((image) => (
                                                <div key={image.id}
                                                    ...
                                                    {/* Button cho mobile */}
                                                    <button
                                                        onClick={() => handleDownload(image.url, `anime-${image.id}.png`)}
