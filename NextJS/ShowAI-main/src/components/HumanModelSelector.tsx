...
import { HumanModel, humanModels } from '../utils/humanModels';

interface HumanModelSelectorProps {
    isOpen: boolean;
    onClose: () => void;
    onSelectModel: (model: HumanModel) => void;
    currentModel: HumanModel;
}

const HumanModelSelector: React.FC<HumanModelSelectorProps> = ({ isOpen, onClose, onSelectModel, currentModel }) => {
        ...
        >
            ...
            >
                <div className="flex justify-between items-center p-4 border-b border-white/10">
                    <h2 className="text-xl font-bold text-white">Chọn mô hình tạo ảnh người</h2>
                    <button
                        onClick={onClose}
...
export default HumanModelSelector; 