...
/* Created on:     12/25/2024 11:08:23 AM                       */
/*==============================================================*/
...
/* Index: cua_FK                                                */
/*==============================================================*/
create index cua_FK on KhachHang (
TenTaiKhoan ASC
)
go
...
/* Index: thuoc_FK                                              */
/*==============================================================*/
create index thuoc_FK on NhanVien (
TenTaiKhoan ASC
)
go
...
/* Index: cap_FK                                                */
/*==============================================================*/
create index cap_FK on PhieuNhap (
MaNhaCungCap ASC
)
go
...
/* Index: seco_FK                                               */
/*==============================================================*/
create index seco_FK on PhieuNhap (
MaNhanVien ASC
)
go
...
/* Index: sanxuat_FK                                            */
/*==============================================================*/
create index sanxuat_FK on SanPham (
MaHang ASC
)
go
...
/* Index: thuoc2_FK                                             */
/*==============================================================*/
create index thuoc2_FK on TaiKhoan (
MaNhanVien ASC
)
go
...
/* Index: cua2_FK                                               */
/*==============================================================*/
create index cua2_FK on TaiKhoan (
MaKhachHang ASC
)
go
